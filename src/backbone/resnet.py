...
from .core import BackboneSpec, _take
...
class ResnetBackbone(BackboneSpec):
    def __init__(
        self,
        backbone: str,
        ...
        resnet = torchvision.models.__dict__[backbone](pretrained=pretrained)
        resnet_params = RESNET_PARAMS[backbone]
